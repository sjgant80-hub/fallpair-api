...
HTTP API wrapping `@ai-native-solutions/fallpair-sdk`.
...
- **Discoverable** — indexed on the FallMarket catalog at [sjgant80-hub.github.io/fallmarket/listing.html?id=fallpair-api](https://sjgant80-hub.github.io/fallmarket/listing.html?id=fallpair-api)
...
- **Companion SDK** (`npm install @ai-native-solutions/fallpair-api-sdk`) — programmatic JavaScript API for direct integration.
- **Companion MCP server** (`claude mcp add fallpair-api -- npx -y @ai-native-solutions/fallpair-api-mcp`) — Model Context Protocol server that any Claude/Cursor/Codex client can invoke as a tool.
- **Companion HTTP API** (`docker run --rm ghcr.io/sjgant80-hub/fallpair-api-api`) — containerized REST endpoint for language-agnostic access.
...
- **Registry entry**: https://sjgant80-hub.github.io/fallmarket/listing.html?id=fallpair-api
- **Live URL**: https://sjgant80-hub.github.io/fallpair-api/
- **Source**: https://github.com/sjgant80-hub/fallpair-api
